...
zoom_const = fractions.fraction(numerator=95, denominator=100)
import time
print('h\n')
plt.imshow(mandelbrot.main(xmin, xmax, ymin, ymax, 480, 480, 100, False))
plt.show()
print('\ng')
def thread(yt, yb, lx, rx, i):
    ...
    return np.rot90(mandelbrot.main(yt, yb, lx, rx, 480, 480, 200+i, False))
